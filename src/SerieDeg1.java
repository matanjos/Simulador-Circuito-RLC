 ...
 * @author Jonas-ws
 */
public class SerieDeg1 extends javax.swing.JFrame {
    RLCserieDeg c3 =new RLCserieDeg();
    ...
    public SerieDeg1() {
        ...
        imgSe.add(L);
        imgSe.add(C);
        fonteCorrente.setLocation((int)(imgSe.getWidth()*0.42), (int)(imgSe.getHeight()*0.01));
        fonte.setLocation((int)(imgSe.getWidth()*0.42), (int)(imgSe.getHeight()*0.9));
        R1.setLocation((int)(imgSe.getWidth()*0.05), (int)(imgSe.getHeight()*0.62));
        R2.setLocation((int)(imgSe.getWidth()*0.85), (int)(imgSe.getHeight()*0.62));
        L.setLocation((int)(imgSe.getWidth()*0.3), (int)(imgSe.getHeight()*0.32));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(244, 244, 244)
                .addComponent(imgSe, javax.swing.GroupLayout.PREFERRED_SIZE, 786, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String fonteCin = JOptionPane.showInputDialog(null, "Insira o valor da fonte de Corrente: (A)", "Alterar Valores",JOptionPane.QUESTION_MESSAGE);
        double fonteCval = Double.parseDouble(fonteCin.replaceAll(",","."));
        c3.fonteCorrente = fonteCval;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        new SerieDeg1RES(c3).setVisible(true);
